        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r2 : r.values()) {
                ...
                if (r.values().size() > 0) {
                	...
                	m_out.println("<h1 class='header' align='center'>" + "Review Manually"+ "</h1>");
                }
...
//                    + method.getMethodName() + "</h2>");
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        ...
        m_out.print("<tr>");
        tableColumnStart("Task Name");
        tableColumnStart("Tasks<br/>Executed");
        tableColumnStart("Task<br/>Passed");
        tableColumnStart("Task<br/>Skipped");
        tableColumnStart("Task<br/>Failed");
...
//                summaryCell(overview.getExcludedGroups());
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println(".top-banner-title-font {height:100px; display:block; background-color:#989aa1; color:#ffffff;font-size:15mm}");
        out.println(".table-banner{background-color:#989aa1;height:100px;}");
        out.println("</style>");
        out.println("</head>");
        out.println("<body>");
        out.println("<div class='swa-header' role='banner'>");
        out.println("<table bgcolor='#6897bb' border=1px width='100%' align='center' cellspacing='0' cellpadding='0' class='banner'>");
        out.println("<tr ><th>");
        out.println("<div align='center' class='swa-header--title'>");
        out.println("<img align='left' src='file:"+(System.getProperty("user.dir")) + "/test-output/mycompany_color.png"+"'></img>");
    ...
    protected void endHtml(PrintWriter out) {
    	...
    	out.println("</br/>");
    	out.println("</br/>");
    	out.println("<center> Automation Report [jose.tester@gmail.com] </center>");
    	out.println("</footer>");
